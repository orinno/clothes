                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="input_kode_konsumen" readonly
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="input_nama_konsumen" readonly
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <select class="form-control select2" id="select_paket" name="id_paket">
                                        ...
                                        @foreach ($paket as $item)
                                            <option value="{{ $item->id }}"
                                                ...
                                                data-harga="{{ $item->harga }}">{{ $item->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="tanggal_masuk" id="input_tanggal_masuk" readonly class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="tanggal_keluar" id="input_tanggal_keluar" readonly class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="invoice" id="input_kode_transaksi" readonly class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="total_bayar" id="input_total_bayar" readonly class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
