<aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a class="nav-link" href="/dashboard/paket"><i class="fas fa-boxes-packing"></i> <span>Paket</span></a></li>
              <li><a class="nav-link" href="/dashboard/tipe_pembayaran"><i class="fas fa-money-bill-wave"></i> <span>Tipe Pembayaran</span></a></li>
              <li><a class="nav-link" href="/dashboard/status_pesanan"><i class="fas fa-boxes-stacked"></i> <span>Status</span></a></li>
              <li class="menu-header">User Management</li>
              <li><a class="nav-link" href="/dashboard/konsumen"><i class="fas fa-users"></i> <span>Konsumen</span></a></li>
              <li><a class="nav-link" href="/dashboard/karyawan"><i class="fas fa-user-tie"></i></i> <span>Karyawan</span></a></li>
